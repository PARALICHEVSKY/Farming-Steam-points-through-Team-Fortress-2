// Command-line mode for advanced users. Without a command, the interactive menu starts.
...
const HELP = `Использование: node src/index.js [команда] [--keys N] [--cycles N]
  ...
  (без команды) простое меню с подсказками — рекомендуется
  setup      пошаговая настройка аккаунта
